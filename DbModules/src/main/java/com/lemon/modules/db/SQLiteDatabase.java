...
import com.lemon.common.exception.DBNotOpenException;
import com.lemon.common.log.Logger;
import com.lemon.modules.db.entity.ABArrayList;
import com.lemon.modules.db.entity.DBHashMap;
import com.lemon.modules.db.entity.DBMapArrayList;
import com.lemon.modules.db.entity.DBMasterEntity;
import com.lemon.modules.db.util.DBUtils;
import com.lemon.modules.db.util.SqlBuilderFactory;
...
{
	// 数据库默认设置
	private final static String DB_NAME = "data.db"; // 默认数据库名字
	...
	{
		Logger.i(SQLiteDatabase.this, sql);
		if (testSQLiteDatabase())
		{
			...
			{
				Logger.e(SQLiteDatabase.this, "执行" + sql + "错误");
			}
		} else
		{
			Logger.e(SQLiteDatabase.this, "数据库未打开！");
		}
		return null;
	}
			...
			String groupBy, String having, String orderBy, String limit)
	{
		...
		if (testSQLiteDatabase())
		{
			...
			try
			{
				...
				Logger.i(SQLiteDatabase.this, "执行" + sqlString);
				free();
			...
			} catch (IllegalArgumentException e)
			{
				...
				Logger.e(SQLiteDatabase.this, e.getMessage());
				e.printStackTrace();
			...
			String having, String orderBy)
	{
		if (testSQLiteDatabase())
		{
			...
			{
				Logger.e(SQLiteDatabase.this, "查询" + table + "错误");
			}
		} else
		{
			Logger.e(SQLiteDatabase.this, "数据库未打开！");
	...
	public void execute(String sql, String[] bindArgs)
			throws DBNotOpenException
	{
		Logger.i(SQLiteDatabase.this, "准备执行SQL[" + sql + "]语句");
		if (testSQLiteDatabase())
		{
			if (sql != null && !sql.equalsIgnoreCase(""))
			{
	...
	public DBMapArrayList<String> getQueryCursorData()
	{
		...
		if (queryCursor != null)
		{
			...
			{
				e.printStackTrace();
				Logger.e(SQLiteDatabase.this, "当前数据集获取失败！");
			}
		} else
		{
			Logger.e(SQLiteDatabase.this, "当前数据集不存在！");
		}
		return arrayList;
	}
	...
	public boolean hasTable(String tableName)
	{
		...
		{
			Logger.e(SQLiteDatabase.this, "判断数据表名不能为空！");
		}
		return false;
	}
	...
	public Boolean dropTable(String tableName)
	{
		...
		{
			Logger.e(SQLiteDatabase.this, "删除数据表名不能为空！");
		}
		return isSuccess;
	}
	...
	public String error()
	{
		...
		Logger.e(SQLiteDatabase.this, error);
		return error;
	}
